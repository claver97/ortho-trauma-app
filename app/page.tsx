    ...
    <div className="min-h-screen bg-slate-100 p-6">
      <div className="max-w-5xl mx-auto bg-white rounded-3xl shadow-xl p-8">
        ...
        <form className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            <label className="block text-sm font-semibold mb-2">MRN / Hospital ID</label>
            <input
              type="text"
              name="mrn"
              value={formData.mrn}
          ...
          <div>
            <label className="block text-sm font-semibold mb-2">Medical History</label>
            <textarea
              name="medHx"
          ...
          <div>
            <label className="block text-sm font-semibold mb-2">Surgical History</label>
            <textarea
              name="surgHx"
          ...
          <div>
            <label className="block text-sm font-semibold mb-2">Neurovascular Status</label>
            <select
              name="nvb"
              value={formData.nvb}
              onChange={handleChange}
          ...
          <div>
            <label className="block text-sm font-semibold mb-2">Skin Condition</label>
            <select
              name="skin"
              value={formData.skin}
              onChange={handleChange}
          ...
          <div className="md:col-span-2">
            <label className="block text-sm font-semibold mb-2">Temporary Management</label>
            <textarea
              rows="3"
              name="tempManagement"
          ...
          <div className="md:col-span-2">
            <label className="block text-sm font-semibold mb-2">Upload X-ray Images</label>
            <input
              type="file"
              multiple
          ...
          <div className="md:col-span-2 flex flex-col md:flex-row gap-4 justify-center pt-4">
            <button
              ...
              className="bg-green-600 hover:bg-green-700 text-white px-10 py-4 rounded-2xl text-lg font-semibold transition-all duration-300 shadow-lg"
            >
              Send to WhatsApp
            </button>
            ...
            <button
              type="submit"
              className="bg-slate-800 hover:bg-slate-900 text-white px-10 py-4 rounded-2xl text-lg font-semibold transition-all duration-300 shadow-lg"
            >
              Save Admission
            </button>
          </div>
        ...
        <div className="mt-12 bg-slate-50 rounded-3xl p-6 border border-slate-200">
          <h2 className="text-2xl font-bold mb-4 text-slate-800">
            Future Features
          </h2>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-slate-600">
            <div>✅ Automatic Notion Sync</div>
            <div>✅ WhatsApp Parsing</div>
            <div>✅ AO Classification</div>
            <div>✅ Operative Logbook</div>
            <div>✅ Follow-up Tracking</div>
            <div>✅ Research Export (Excel/SPSS/R)</div>
          </div>
        </div>
      </div>
    </div>
